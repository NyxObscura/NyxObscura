...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=28&duration=3000&color=3DBEFC&center=true&vCenter=true&width=800&height=60&lines=Welcome+to+My+GitHub+Universe;I'm+Obscura+Student;Full-Stack+Developer+%7C+Lifelong+Learner;Let's+Build+Amazing+Things+Together!">
</div>
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=html,css,sass,js,ts,abap,ada,arduino,assembly,bash,c,clojure,cpp,cs,csharp,cobol,delphi,dart,elixir,erlang,fsharp,fortran,go,graphql,haskell,java,julia,kotlin,lua,matlab,nim,nodejs,ocaml,perl,php,powershell,python,r,racket,ruby,rust,scala,scheme,scratch,shell,swift,solidity,sql,zig,v,vim,wasm,dotnet,electron,flask,fastapi,spring,laravel,rails,react,nextjs,vue,svelte,angular,nuxtjs,gatsby,qt,bots,redux,jest,d3,threejs,express,nginx,jenkins,gulp,gradle,cmake,babel,webpack,bootstrap,tailwind,materialui,styledcomponents,wordpress,ghost,threejs,openshift,regex,replit,stackoverflow,linux,ubuntu,debian,alpine,aws,gcp,azure,docker,kubernetes,postgres,mysql,mongodb,sqlite,redis,firebase,supabase,git,github,gitlab,bitbucket,vscode,visualstudio,atom,eclipse,intellij,pycharm,phpstorm,neovim,figma,xd,blender,unreal,unity,raspberrypi,arduino,ansible,terraform,grafana,prometheus" alt="Skills" width="900">
</div>
